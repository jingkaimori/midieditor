...
AdditionalMidiSettingsWidget::AdditionalMidiSettingsWidget(QSettings* settings, QWidget* parent)
    ...
    MidiOutput::omitSysExLength = _settings->value("omitSysExLength", false).toBool();
    ...
    layout->addWidget(new QLabel(tr("Metronome loudness:"), this), 9, 0, 1, 2);
    ...
    layout->addWidget(new QLabel(tr("Start command:"), this), 12, 0, 1, 2);
...
void AdditionalMidiSettingsWidget::omitSysExtLength(bool enable)
{
    ...
    _settings->setValue("omitSysExLength", enable);
