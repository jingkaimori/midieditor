...
AutomaticUpdateDialog::AutomaticUpdateDialog(
    ...
    QLabel *content = new QLabel(tr("<html>"
                                    ...
                                    "<p>"
                                    "When checking for updates, ProMidEdit transmits your IP address as well as the currently "
                                    "installed version of ProMidEditor and you operating system to a server which is located within the European Union."
                                    "</p>"
                                    "<p>"
                                    ...
                                    "understood the terms under which ProMidEdit provides this service and "
