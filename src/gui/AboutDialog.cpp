...
AboutDialog::AboutDialog(QWidget* parent)
    ...
    QLabel* content = new QLabel("<html>"
                                 "<body>"
                                 "<p>"
                                 "<a href=\"https://bardmusicplayer.com/docs/chipmidieditor/\">https://bardmusicplayer.com/docs/chipmidieditor</a><br>"
                                 "support@bardmusicplayer.com"
                                 "</p>"
                                 "<h3>Author</h3>"
                                 "<p>"
                                 "Chipotle Ismylife<br>"
                                 "Email: hopper.dustin@gmail.com<br>"
                                 "Website: <a href=\"http://trotlinebeercan.com\">www.trotlinebeercan.com</a><br>"
                                 "</p>"
                                 "<p>"
