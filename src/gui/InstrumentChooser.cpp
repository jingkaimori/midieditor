    ...
    : QDialog(parent)
{
    ...
    QLabel* endText;
    if(!mode) endText = new QLabel(tr("<b>Warning:</b> this will edit the event at tick 0 of the file."
    ...
    if(!mode) _removeOthers = new QCheckBox(tr("Remove other Program Change Events"), this);
    else _removeOthers = new QCheckBox(tr("Remove this Program Change Events"), this);
