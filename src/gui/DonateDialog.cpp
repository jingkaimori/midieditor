...
DonateDialog::DonateDialog(QWidget* parent)
    ...
    QLabel* content = new QLabel(tr("<html>"
                                    ...
                                    "<p>"
                                    "Dear User,<br>"
                                    "I offer ProMidEdit for free and I hope you enjoy it. Please note that I developed the editor during my spare time and that I've been working on it for more than four years by now! If ProMidEdit is useful for you, please send me a little donation so that I can at least cover my huge coffee-bill ;)  <br>"
                                    "</p>"
                                    "<h3>How to donate</h3>"
                                    "<p>"
                                    ...
                                    "<a href=\"https://donationalerts.com/c/prophessor\">https://donationalerts.com/c/prophessor</a>"
                                    "</p>"
                                    "<h3>Thank you!</h3>"
                                    "<p>"
                                    "Your donation will help me to maintain and update ProMidEdit."
                                    "</p>"
                                    "<h3>Other ways to Contribute</h3>"
                                    "<p>"
                                    "<a href=\"https://github.com/PROPHESSOR/ProMidEdit\">Rate ProMidEdit and provide feedback</a> to let me and other users know about how you liked the software!"
                                    "</p>"
                                    "</body>"
                                    "</html>"));
